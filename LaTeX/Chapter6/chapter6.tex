...
The following sections are set out as follows. Section \ref{carbonoptim:sec:litreview} covers examples of optimisations using genetic algorithms and different carbon strategies. Section \ref{carbonoptim:sec:optimisation} details the optimization techniques applied. We present our results in Section \ref{sec:results}, and conclude in Section \ref{sec:conclusion}.
