...
\begin{figure*}
	\centering
	\includegraphics[width=0.8\linewidth]{Chapter4/figures/low_level_system}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.35\textwidth]{Chapter4/figures/load_price_duration_curve_comparison-monte-carlo.pdf}
