...
Equation \ref{elecsim:eq:medoids_series} shows the series for a medoid or centroid, selected by the $k$-means algorithm:
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth, keepaspectratio]{Chapter4/figures/e-Energy-2020/results/scenario_analysis/optimal_pdc_prices.pdf}
...
In this section we discuss various scenarios under the model which uses representative days as time-steps. This work builds upon the work in Section \ref{architecture:sec:validation}; we used the same predicted price duration curves as modelled on BEIS' scenario. 
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{0.6\textwidth}
		...
		\caption{\small \textsterling10 carbon tax.}
		\label{fig:demand10}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.6\textwidth}  
