...
\begin{table}[]
	...
	\begin{tabular}{p{7.5cm}p{7.5cm}}
		...
		Energy systems modeling for twenty-first century energy challenges \cite{Pfenninger2014}                                   & The issues of using existing models for twenty-first century challenges in energy.                           \\ \midrule
		A review of energy systems models in the UK: Prevalent usage and categorisation \cite{Hall2016}                            & Provide a classification schema for energy models.                                                           \\ \midrule
...
\begin{table}[]
	...
	\begin{tabular}{p{5cm}p{7cm}ll@{}}
		...
		Energy system optimisation models          & MARKAL~\cite{Fishbone1981a}, TIMES~\cite{Giannakidis2013}, MESSAGE~\cite{Schrattenholzer1981}, OSeMOSYS~\cite{Howells2011}        & Normative scenarios                      \\
		Energy system simulation models            & LEAP\cite{LEAP2012a}, NEMS~\cite{Grozev2005}, PRIMES\cite{Capros2012}                       & Forecasts, predictions                   \\
...
\begin{table}[]
	...
	\caption{Model schema and presentation of various energy models \cite{Hall2016}}
