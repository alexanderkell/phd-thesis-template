...
In practice, it is possible for models to lie between any of these paradigms, and within a top-down or bottom-up approach. Table \ref{tab:litreview:modeltypes} displays the model families, examples of such models and their primary focus, whereas Table \ref{table:litreview:abm_comparison}
...
ELMOD is a bottom-up electricity market model. It is considers the engineering and economic data of the European electricity market, and considers 24 hour windows with an hourly resolution. It is formulated as a non-linear mathematical programming problem, and can be used for applications such as market design or investment decisions.
