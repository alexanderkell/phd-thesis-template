...
In this Chapter we use several different machine learning and statistical methods to predict electricity demand 30 minutes ahead and a day ahead. The 30 minutes ahead methodology is used in the work on day-ahead work. We utilise the errors from the day ahead predictions to see what the impact of such errors are on the day-ahead market. This work was published in \cite{Kell2018}. The work looks specifically at the difference in electricity mix with prediction error, as well as carbon emitted.
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{Chapter5/figures/short-term-forecasting/Rplot01.png}
...
\begin{figure}
		\centering
	\includegraphics[width=0.4\textwidth]{Chapter5/figures/short-term-forecasting/Rplot02.png}
...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{Chapter5/figures/short-term-forecasting/rforest_parameter_tuning}
...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{Chapter5/figures/short-term-forecasting/results.png}
	\caption{Comparison of accuracy of models forecasting electricity with varying number of clusters.}
	\label{fig:results}
\end{figure}

\begin{figure}
	\includegraphics[width=0.5\textwidth]{Chapter5/figures/short-term-forecasting/Cluster_Centres.png}
...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{Chapter5/figures/short-term-forecasting/calendar_attr.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/offline_model_mae.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/ExtraTreesRegressor_distribution_plot.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/online_learning_dists-power-0.1.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/online_learning_dists-C-0.1-fit_intercept-true-max_iter-1000-shuffle-false-tol-001.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/both_actual_predicted.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/online_testing_time_vs_mae_all_results_opaque.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{Chapter5/figures/market-forecasting/results/online_training_time_vs_mae_all_results_opaque.eps}
