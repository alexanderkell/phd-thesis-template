...
\begin{figure}
	\centering
	\includegraphics[width=0.75\columnwidth]{Chapter5/figures/market-forecasting/results/both_pred_actuals_plot_difference.png}
	\caption{Best offline model compared to the best online model over a one week period for day-ahead forecasting.}
