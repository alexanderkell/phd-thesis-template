...
\begin{figure}
    \includegraphics[width=0.4\textwidth]{Chapter5/figures/online_learning/methods/Kell_eEnergy_Fig1.eps}
    \caption{A three layer feed forward neural network.}
    \label{fig:mlp}
\end{figure}
...
\begin{figure}
    \includegraphics[width=0.48\textwidth,natwidth=610,natheight=400]{Chapter5/figures/online_learning/methods/System_overview_large.png}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{Chapter5/figures/online_learning/results/offline_model_mae.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{Chapter5/figures/online_learning/results/ExtraTreesRegressor_distribution_plot.eps}
...
\begin{figure}
%\centering
\includegraphics[width=\columnwidth,natwidth=1300,natheight=1300]{Chapter5/figures/online_learning/results/online_model_mae_barplot.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{Chapter5/figures/online_learning/results/online_learning_dists-power-0.1.eps}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth,natwidth=500,natheight=500]{Chapter5/figures/online_learning/results/online_learning_dists-C-0.1-fit_intercept-true-max_iter-1000-shuffle-false-tol 0.001.eps}
...
\begin{subfigure}[b]{0.3\textwidth}  
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Coal_mean_output.eps}
\caption{Coal output.}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Nuclear_mean_output.eps}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Offshore_mean_output.eps}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=1\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Recip_gas_mean_output.eps}
...
\begin{subfigure}[b]{0.3\textwidth}
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_CCGT_mean_output.eps}
\caption{Total CCGT.}
...
\begin{subfigure}[b]{0.3\textwidth}  
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Coal_mean_output.eps}
\caption{Total Coal.}
...
%\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}   
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Onshore_mean_output.eps}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Offshore_mean_output.eps}
\caption{Total Offshore.}
\label{fig:total_Offshore_mean_output}
\end{subfigure}
\hfil
\begin{subfigure}[b]{0.3\textwidth}
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Nuclear_mean_output.eps}
...
%\centering
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_PV_mean_output.eps}
...
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Recip_gas_mean_output.eps}
...
\hfil
\begin{subfigure}[b]{0.33\textwidth}   
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/Carbon_emitted_mean_output.eps}
