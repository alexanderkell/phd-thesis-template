...
The integration of higher proportions of intermittent renewable energy sources (IRES) in the electricity grid will mean that the forecasting of electricity demand will become increasingly important and difficult. Examples of IRES are solar panels and wind turbines, which fluctuate in terms of power output based on localized wind speed and solar irradiance. Supply must meet demand at all times and the fact that IRES are less predictable than dispatchable energy sources such as coal and combined-cycle gas turbines (CCGTs) means extra attention must be made to predicting future demand \cite{Lu1993}. A dispatchable source is one that can be turned on and off by human control and therefore able to adjust output at late notice and a time convenient for the grid.
...
To reduce reliance on peaker plants, it is helpful to know how much electricity demand there will be in the future so that more efficient plants can be used to meet this demand. Forecasting a day into the future is especially useful in decentralized electricity markets which have day-ahead markets. To aid in this prediction, machine learning and statistical techniques have been used to accurately predict demand based on several different factors and data sources \cite{Kell2018a}, such as weather \cite{Hong2014}, day of the week \cite{Al-Musaylh2018} and holidays \cite{Vrablecova2017}. 
...
\begin{figure}
    \includegraphics[width=0.4\textwidth]{Chapter5/figures/online_learning/methods/Kell_eEnergy_Fig1}
    \caption{A three layer feed forward neural network.}
    \label{fig:mlp}
\end{figure}
...
\begin{figure}
    \includegraphics[width=0.48\textwidth]{Chapter5/figures/online_learning/methods/System_overview_large.png}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/offline_model_mae}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/offline_rf_actual_predicted}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/ExtraTreesRegressor_distribution_plot}
...
\begin{figure}
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/online_model_mae_barplot}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/online_learning_dists-power-0.1}
...
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/online_learning_dists-C-0.1-fit_intercept-true-max_iter-1000-shuffle-false-tol-0001}
...
Figure \ref{fig:contributed_PV_mean_output} displays the mean photovoltaic (PV) contributed between 2018 and 2035 vs. mean absolute error of the various online regressor models displayed in Figure \ref{fig:online_model_mae_barplot}. A positive correlation can be seen with PV contributed and mean absolute error. This is similar for coal and nuclear output, shown in Figures \ref{fig:contributed_Coal_mean_output} and \ref{fig:contributed_Nuclear_mean_output} respectively. However, as shown by Figure \ref{fig:contributed_Offshore_mean_output}, offshore wind reduces with mean absolute error. Figure \ref{fig:contributed_Recip_gas_mean_output} displays the mean reciprocal gas engine output vs mean absolute error between the same time period. Output for the reciprocal gas engine also increases with mean absolute error.
...
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_PV_mean_output}
...
\begin{subfigure}[b]{0.3\textwidth}  
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Coal_mean_output}
\caption{Coal output.}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Nuclear_mean_output}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Offshore_mean_output}
\caption{Offshore output.}
\label{fig:contributed_Offshore_mean_output}
\end{subfigure}
\hfil
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=1\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/contributed_Recip_gas_mean_output}
...
%\begin{subfigure}
%%\centering
%\includegraphics[width=0.3\textwidth]{figures/results/elecsim_results/contributed_Recip_gas_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/contributed_Coal_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/contributed_Nuclear_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/contributed_Offshore_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/contributed_Onshore_mean_output}
%\caption{Mean onshore output vs. mean absolute error from 2018 to 2035 in ElecSim.}
%\label{fig:contributed_Onshore_mean_output}
%\end{figure}
...
CCGT, onshore, and reciprocal gas engines are invested in less over the time period, as shown by Figures \ref{fig:total_CCGT_mean_output}, \ref{fig:total_Offshore_mean_output}, \ref{fig:total_Recip_gas_mean_output} respectively. While coal, offshore, nuclear and photovoltaics all exhibit increasing investments.
...
\begin{subfigure}[b]{0.3\textwidth}
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_CCGT_mean_output}
\caption{Total CCGT.}
...
\begin{subfigure}[b]{0.3\textwidth}  
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Coal_mean_output}
\caption{Total Coal.}
...
%\vskip\baselineskip
\begin{subfigure}[b]{0.3\textwidth}   
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Onshore_mean_output}
...
\begin{subfigure}[b]{0.3\textwidth}   
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Offshore_mean_output}
\caption{Total Offshore.}
\label{fig:total_Offshore_mean_output}
\end{subfigure}
\hfil
\begin{subfigure}[b]{0.3\textwidth}
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Nuclear_mean_output}
...
%\centering
%\centering
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_PV_mean_output}
...
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/total_Recip_gas_mean_output}
\caption{Total Reciprocal gas engine.}
\label{fig:total_Recip_gas_mean_output}
\end{subfigure}
%\quad
%\medskip
\hfil
\begin{subfigure}[b]{0.33\textwidth}   
\includegraphics[width=\columnwidth]{Chapter5/figures/online_learning/results/elecsim_results/results_2/Carbon_emitted_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_CCGT_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_Coal_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_Offshore_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_Onshore_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_PV_mean_output}
...
%\begin{figure}
%\centering
%\includegraphics[width=\columnwidth]{figures/results/elecsim_results/total_Recip_gas_mean_output}
